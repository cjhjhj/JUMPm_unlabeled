...
uid, otherIds, name, synonym, formula, energy, inchikey, smiles, iontype, mode, rt, mass, precmz, charge = \
    "NA", "NA", "NA", "NA", "NA", "NA", "NA", "NA", "NA", None, None, None, None, None
...
dictLib = {"id": [], "other_ids": [], "name": [], "synonym": [], "formula": [], "precursor_mz": [], "mass": [],
           "ion_type": [], "mode": [], "energy": [], "smiles": [], "inchikey": [], "rt": [], "charge": []}
...
for i in range(dfDecoy.shape[0]):
    ...
    dfDecoy.loc[i, "mass"] += dfDecoy.loc[i, "mode"] * 3 * proton # This way prevents 'SettingwithCopyWarning'
    dfDecoy.loc[i, "precursor_mz"] += dfDecoy.loc[i, "mode"] * 3 * proton / dfDecoy.loc[i, "charge"]
